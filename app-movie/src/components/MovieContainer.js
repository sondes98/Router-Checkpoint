...
const MovieContainer = ({movies, setMovies, fetchData}) => {
    ...
    <>
      ...
      <navbar className="nav-b" style={{display: 'flex'}}>
      <Link href="/" className="home"> Home </Link>
      <form className="wrapper"  onSubmit={onSubmitHandler}>
      ...
      <input className="search" ref={searchEL} type="search" 
            className="form-control rounded" placeholder="   Search for a movie ..." aria-label="Search"
      ...
      <div className="page-title"> <h1> Welcome to YoMovie </h1></div>
